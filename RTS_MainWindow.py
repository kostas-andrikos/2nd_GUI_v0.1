...
from RTS_ToolsetGui import RapidTowSteeringToolsetGui
...
class RapidTowSteeringMainWindow(AFXMainWindow):
    ...
    def __init__(self, app, windowTitle=''):
        ...
        self.registerToolset(RapidTowSteeringToolsetGui(), GUI_IN_MENUBAR|GUI_IN_TOOLBOX)
